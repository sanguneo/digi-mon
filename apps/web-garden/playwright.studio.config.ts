...
export default defineConfig({
  testDir: './test/e2e', testMatch: ['studio-first.spec.ts', 'problem-selection.spec.ts', 'puppy-asset.spec.ts', 'care-reactions.spec.ts', 'garden-worlds.spec.ts', 'mobile-first.spec.ts', 'worksheet-*.spec.ts', 'response-integrity.spec.ts', 'garden-learning.spec.ts'],
