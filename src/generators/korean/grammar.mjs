...
const PUNCTUATION = [
  { mark: '.', name: '마침표', use: '설명하는 문장 끝', samples: ['오늘은 날씨가 좋습니다', '나는 학교에 갑니다', '동생이 그림을 그립니다', '교실에 친구가 많습니다', '아침에 우유를 마셨습니다'] },
  { mark: '?', name: '물음표', use: '묻는 문장 끝', samples: ['이것은 무엇입니까', '어디에 가십니까', '누가 먼저 왔습니까', '연필이 몇 자루입니까', '언제 시작합니까'] },
  { mark: '!', name: '느낌표', use: '느낌을 나타내는 문장 끝', samples: ['참 잘했구나', '날씨가 정말 좋구나', '와, 무지개가 떴구나', '정말 대단하구나', '꽃이 참 예쁘구나'] },
