...
export const HYPERNYMS = [
  ...
  { general: '옷', specific: ['양말', '장갑', '바지'] },
  { general: '그릇', specific: ['접시', '냄비', '컵'] },
];
 ...
 *
 * 회귀 주의 — 주체 높임과 객체 높임이 한 표에 섞여 있다.
...
export const TENSE_CASES = [
  ...
  { adverb: '다음 주에', tense: '미래', form: '만날 것입니다', wrong: ['만났습니다', '만납니다'] },
  { adverb: '아까', tense: '과거', form: '읽었습니다', wrong: ['읽습니다', '읽을 것입니다'] },
  { adverb: '지난달에', tense: '과거', form: '심었습니다', wrong: ['심습니다', '심을 것입니다'] },
  { adverb: '오늘', tense: '현재', form: '연습합니다', wrong: ['연습했습니다', '연습할 것입니다'] },
  { adverb: '모레', tense: '미래', form: '떠날 것입니다', wrong: ['떠났습니다', '떠납니다'] },
  { adverb: '방금', tense: '과거', form: '끝냈습니다', wrong: ['끝냅니다', '끝낼 것입니다'] },
  { adverb: '이번 주에', tense: '현재', form: '준비합니다', wrong: ['준비했습니다', '준비할 것입니다'] },
  { adverb: '내년에', tense: '미래', form: '입학할 것입니다', wrong: ['입학했습니다', '입학합니다'] },
];
