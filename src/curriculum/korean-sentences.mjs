 ...
 * 뜻이고, 쉼표·주어부·이어 주는 말 다음이 그 자리다.
 * `words` 는 어절 배열이고 `breakAfter` 는 0부터 센 어절 번호다.
 */
export const READING_BREAKS = [
  { words: ['나는', '학교에', '갑니다'], breakAfter: 0, basis: '누가 하는지를 나타내는 말 다음에서 끊어 읽는다' },
  { words: ['동생이', '우유를', '마십니다'], breakAfter: 0, basis: '누가 하는지를 나타내는 말 다음에서 끊어 읽는다' },
  { words: ['꽃이', '활짝', '피었습니다'], breakAfter: 0, basis: '누가 하는지를 나타내는 말 다음에서 끊어 읽는다' },
  { words: ['비가', '와서', '우산을', '썼습니다'], breakAfter: 1, basis: '이어 주는 말 다음에서 끊어 읽는다' },
  { words: ['날씨가', '추워서', '장갑을', '꼈습니다'], breakAfter: 1, basis: '이어 주는 말 다음에서 끊어 읽는다' },
  { words: ['사과와', '배와', '귤을', '샀습니다'], breakAfter: 2, basis: '늘어놓은 말이 끝난 다음에서 끊어 읽는다' },
  { words: ['아침에', '일어나서', '세수를', '했습니다'], breakAfter: 1, basis: '이어 주는 말 다음에서 끊어 읽는다' },
  { words: ['우리는', '운동장에서', '공을', '찼습니다'], breakAfter: 0, basis: '누가 하는지를 나타내는 말 다음에서 끊어 읽는다' },
];
...
const TRAILING_PARTICLES = ['에서', '으로', '에게', '까지', '부터', '보다', '와', '과', '은', '는', '이', '가', '을', '를', '로', '도', '만', '의', '에'];

/**
 * 조사가 붙었을 때 한 글자로 남는 낱말.
 *
 ...
 */
const ONE_SYLLABLE_NOUNS = ['비', '눈', '물', '불', '꽃', '옷', '밥', '책', '집', '해', '달', '별', '산', '강', '길', '손', '발', '말'];
